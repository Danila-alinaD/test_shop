const products = [{id:1, category:1,
    ...
    uk:{name:"Розмальовка Cвинка Пеппа", desc:"Велика розмальовка зі Свинкою Пеппою з чіткими та простими контурами для зручного розфарбовування. Підійде для дівчат і хлопчиків, розвиває уяву, уважність і приносить багато радості від творчості.", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска Cвинка Пеппа", desc:"Большая раскраска со Свинкой Пеппой с четкими и простыми контурами для удобного раскрашивания. Подходит для девочек и мальчиков, развивает воображение, внимательность и приносит много радости от творчества.", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300}
    },{id:7, category:1,
    ...
    images:["img/p_uni.jpg.webp","img/p_uni.jpg.webp","img/p_uni.jpg.webp"],
    uk:{name:"Стікери Чернівці", desc:"Опис товару 15", material:"ПВХ", size:"Розмір", quantity:"210 шт", weight:"105 г", price:50},
    ru:{name:"Товар 15", desc:"Описание товара 15", material:"ПВХ", size:"Размер", quantity:"210 шт", weight:"105 г", price:50}
    },{id:16, category:1,
    images:["img/p_uni.jpg.webp","img/p_uni.jpg.webp","img/p_uni.jpg.webp"],
