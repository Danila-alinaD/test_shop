const products = [{id:1, category:1,
    ...
    uk:{name:"Розмальовка Меми", desc:"Опис товару 4", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска 4", desc:"Описание товара 4", material:"Материал", size:"Размер", quantity:"1 шт", weight:"60 г", price:300}
    },{id:5, category:1,
    images:["img/barbie_1.jpg","img/barbie_1.jpg","barbie_1.jpg"],
    uk:{name:"Розмальовка Барбі", desc:"Опис товару 5", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска 5", desc:"Описание товара 5", material:"Материал", size:"Размер", quantity:"1 шт", weight:"90 г", price:300}
    },{id:6, category:1,
    images:["img/pepa_1.jpg","img/pepa_1.jpg","img/pepa_1.jpg"],
    uk:{name:"Розмальовка Cвинка Пепа", desc:"Опис товару 6", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска 6", desc:"Описание товара 6", material:"Материал", size:"Размер", quantity:"1 шт", weight:"125 г", price:300}
    },{id:7, category:1,
    images:["img/p_uni.jpg.webp","img/p_uni.jpg.webp","img/p_uni.jpg.webp"],
    uk:{name:"Розмальовка 7", desc:"Опис товару 7", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска 7", desc:"Описание товара 7", material:"Материал", size:"Размер", quantity:"1 шт", weight:"150 г", price:300}
    },{id:8, category:1,
    images:["img/p_uni.jpg.webp","img/p_uni.jpg.webp","img/p_uni.jpg.webp"],
    uk:{name:"Розмальовка 8", desc:"Опис товару 8", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска 8", desc:"Описание товара 8", material:"Материал", size:"Размер", quantity:"1 шт", weight:"55 г", price:300}
    },{id:9, category:1,
    images:["img/p_uni.jpg.webp","img/p_uni.jpg.webp","img/p_uni.jpg.webp"],
    uk:{name:"Розмальовка 9", desc:"Опис товару 9", material:"Папір", size:"120x150", quantity:"1 шт", weight:"200 г", price:300},
    ru:{name:"Раскраска 9", desc:"Описание товара 9", material:"Материал", size:"Размер", quantity:"1 шт", weight:"80 г", price:300}
    },{id:10, category:1,
    images:["img/p_uni.jpg.webp","img/p_uni.jpg.webp","img/p_uni.jpg.webp"],
    uk:{name:"Розмальовка 10", desc:"Опис товару 10", material:"Папір", size:"120x150", quantity:"1 шт", weight:"70 г", price:300},
    ru:{name:"Раскраска 10", desc:"Описание товара 10", material:"Материал", size:"Размер", quantity:"1 шт", weight:"70 г", price:300}
    },{id:11, category:1,
